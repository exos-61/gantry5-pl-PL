...
define( 'CBLIB', '2.4.6' );	// IMPORTANT: when changing version here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just below
...
class CBLib
{
	protected static $THISCBVERSION		=	'2.4.6+build.2020.09.01.15.39.25.9e994e969';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	/**
	 * @var Application
	 */
