...
class cbInstallerPlugin extends cbInstaller
{
	...
	public function install( $fromDirectory = null, $InstallIntoDatabaseOnly = false )
	{
		...
		$THISCBVERSION			=	'2.4.6+build.2020.09.01.15.39.25.9e994e969';               // IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change 2 times in CBLib.php, the 8 XML installation files and build.xml
